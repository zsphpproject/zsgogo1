...
class Log implements LogHandlerInterface {
    ...
    public function save(array $log): bool
    {
        ...
        $requestId = SnowFlakeUtil::getInstance()->getCurrentId();
        ...
        foreach ($log as $type => $val) {
            ...
            foreach ($val as $msg) {
                ...
                $message[] = $this->config['json'] ?
                    json_encode(['time' => $time, 'type' => $type,'request_id' => $requestId, 'msg' => $msg], $this->config['json_options']) :
                    sprintf($this->config['format'], $time, $type,$requestId, $msg);
            }
